...
public class ClienteController {
    ...
    * 
    * @param cliente El objeto que se actualizará.
    * @return Se devuelve la entidad de respuesta.
    */
    @PutMapping(value="/") 
    public ResponseEntity<Cliente> editar(@RequestBody Cliente cliente){ 
  ...
  /**
   * It takes a string as a parameter, and returns a Cliente object
   * 
   * @param id The id of the client to be consulted.
